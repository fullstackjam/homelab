...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.fullstackjam.dev)**

[![tag](https://img.shields.io/github/v/tag/fullstackjam/homelab?style=flat-square&logo=semver&logoColor=white)](https://github.com/fullstackjam/homelab/tags)
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.fullstackjam.dev)](https://homelab.fullstackjam.dev)
[![license](https://img.shields.io/github/license/fullstackjam/homelab?style=flat-square&logo=gnu&logoColor=white)](https://www.gnu.org/licenses/gpl-3.0.html)
[![stars](https://img.shields.io/github/stars/fullstackjam/homelab?logo=github&logoColor=white&color=gold&style=flat-square)](https://github.com/fullstackjam/homelab)
...
- [Try it out locally](https://homelab.fullstackjam.dev/installation/sandbox) without any hardware (just 4 commands!)
- [Deploy on real hardware](https://homelab.fullstackjam.dev/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.fullstackjam.dev/reference/roadmap) and [open issues](https://github.com/khuedoan/homelab/issues) for a list of proposed features and known issues.

## Contributing

Any contributions you make are greatly appreciated.

Please see [contributing guide](https://homelab.fullstackjam.dev/reference/contributing) for more information.
...
See [license page](https://homelab.fullstackjam.dev/reference/license) or `LICENSE.md` file for more information.
