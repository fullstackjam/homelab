...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.fullstackjam.com)**
...
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.fullstackjam.com)](https://homelab.fullstackjam.com)
...
- [Try it out locally](https://homelab.fullstackjam.com/installation/sandbox) without any hardware (just 4 commands!)
- [Deploy on real hardware](https://homelab.fullstackjam.com/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.fullstackjam.com/reference/roadmap) and [open issues](https://github.com/khuedoan/homelab/issues) for a list of proposed features and known issues.
